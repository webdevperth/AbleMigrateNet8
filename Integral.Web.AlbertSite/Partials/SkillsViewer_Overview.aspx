<%@ Page Language="C#" AutoEventWireup="true"
    CodeFile="SkillsViewer_Overview.aspx.cs"
    Inherits="Integral.Web.PortalSite.Page_Partials.SkillsViewer_Overview" %>
...
<div class="ctlCA360SoT">
  ...
  <div class="flex gap25 flex-column-sm">
    ...
    <div class="boxBorder">
      <div class="boxTitle">
        <h4>Overall Score</h4>
        <%= WebHelper.Icon.TooltipHelp.AddTooltip("All surveys, including Pre and Post").ToString() %>
      </div>
        ...
        <% if (SurveyStats.SelfAllCount > 0) { %>
          <div class="scoreRow">
            ...
            <div class="scoreAcross scoreRight">
              ...
              <div class="subtitle">Self Norm<div class="benchTypeName">(<%= BenchmarkDisplayName %>, n=<%= Bench360ResponseCountSelf %>)</div></div>
            </div>
          </div>
        <% } %>
        <% if (SurveyStats.RaterAllCount > 0) { %>
          <div class="scoreRow raterRow">
            ...
            <div class="scoreAcross scoreRight">
              ...
              <div class="barOuter"><div class="bar"><span>..........</span></div></div>
              <div class="subtitle">Rater Norm<div class="benchTypeName">(<%= BenchmarkDisplayName %>, n=<%= Bench360ResponseCountRater %>)</div></div>
            </div>
          </div>
        <% } %>
      </div>
