<%@ Page Language="C#" AutoEventWireup="true"
    CodeFile="SkillsViewer_HeatMap.aspx.cs"
    Inherits="Integral.Web.PortalSite.Page_Partials.SkillsViewer_HeatMap" %>
...
<div class="Rpt360HeatMap">
  ...
  <div class="flex flex-align-center mb10">
    ...
    <div class="flex flex-align-center gap10">
      <div>Sort By: </div>
      <select class="SkillsViewer_HeatMap_SortBy w125 noselect2">
...
<script type="text/javascript">
  ...
  (function ($) {
    ...
    $(document).ready(function () {
      ...
      selSortBy = $(".SkillsViewer_HeatMap_SortBy");
