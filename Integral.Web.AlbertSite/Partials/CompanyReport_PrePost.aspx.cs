...
namespace Integral.Web.PortalSite.Page_Partials {
  ...
  public partial class CompanyReport_PrePost : AppCode.PageBaseClasses.CompanyReportPartialBase {
    ...
    public void ShowQuestions(Action<string> categoryStart, Action categoryEnd, Action<DbHelper.Reports.PrePost.QuestionInfo> questionDetail) {
