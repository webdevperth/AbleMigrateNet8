...
namespace Integral.Web.PortalSite.ViewComponents {
  ...
  // Model for the OrgRpt_Categories ViewComponent. Mirrors the public API of the
  // legacy UserControls/OrgRpt_Categories.ascx.cs codebehind so the .cshtml view
  // can call GetTableRows/GetScoreBarHTML exactly as the original <% %> blocks did.
  public class OrgRpt_CategoriesModel {
