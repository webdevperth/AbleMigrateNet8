...
namespace Integral.Web.PortalSite.ViewComponents {
  ...
  // Model for the ChartAlbert360ScoreOverTime ViewComponent. Mirrors the public API
  // of the legacy UserControls/ChartAlbert360ScoreOverTime.ascx.cs codebehind so the
  // .cshtml view can render the score boxes and chart JS exactly as the original
  // <%= ... %> blocks did.
  public class ChartAlbert360ScoreOverTimeModel {
