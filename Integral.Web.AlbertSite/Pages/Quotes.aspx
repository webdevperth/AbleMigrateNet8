<%@ Page Language="C#" AutoEventWireup="true"
  CodeFile="Quotes.aspx.cs"
  Inherits="Integral.Web.PortalSite.Pages_Albert.Quotes"
...
<asp:Content ID="BodyContent" runat="server" ContentPlaceHolderID="BodyContent">
   ...
   <% } else { %>
    ...
    <div class="content-action-bar">
      <div class="left">
        <% if (CanViewQuoteListActiveToggle) { %>
          <div class="status-toggle input-group" id="btnGrpActive" data-toggle="buttons">
            <label class="btn <%= searchInfo.StatusClosed ? "" : "active" %>"><input type="radio" name="toggleActive" value="<%= PathHelper.AbleUrlValues.QuoteStatusToggleValue_Active %>" <%= searchInfo.StatusClosed ? "" : "checked" %> />Active</label>
            <label class="btn <%= searchInfo.StatusClosed ? "active" : "" %>"><input type="radio" name="toggleActive" value="<%= PathHelper.AbleUrlValues.QuoteStatusToggleValue_Closed %>" <%= searchInfo.StatusClosed ? "checked" : "" %> />Completed</label>
          </div>
        <% } %>
      ...
      <div class="right">
        <% if (CanCreateQuote) { %>
          <a class="btn btn-primary floatright ml10" href="<%= PathHelper.Pages.QuoteCreate() %>">New Quote</a>
        <% } %>
        <% if (CanRequestQuote) { %>
  ...
  <script type="text/javascript">
    (function($) {
      ...
      $(document).ready(function() {
        ...
        SetActiveToggleValue(<%= SessionHelper.AppState.Quotes.Search_StatusClosed.ToJSTrueFalse() %>);
      ...
      function ShowQuoteRequestModal() {
        ...
        BootstrapDialog.show({
          ...
          onshow: function (dialogRef) {
            ...
            modalBody.load('<%= PathHelper.Partials.QuoteRequestModal("")%>',
                function (data) {
                  modalBody.html(data);
