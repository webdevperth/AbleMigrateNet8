...
namespace Integral.Web.PortalSite.Pages_Albert {
  ...
  public partial class ProgramSendEmail : AppCode.PageBaseClasses.ProgramPageBase {
    ...
    void DoPost() {
      ...
      if (PageAjaxAction == AjaxAction.Upload && Request.ContentType.ToLower().StartsWith("multipart")) {
