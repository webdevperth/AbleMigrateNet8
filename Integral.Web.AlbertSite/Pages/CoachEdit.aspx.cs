...
namespace Integral.Web.PortalSite.Pages_Albert {
  ...
  public partial class CoachEdit : AppCode.PageBaseClasses.CoachInfoBase {
    ...
    void SaveUploadedPartnerPhoto(AjaxSubmitHelper ajax) {
      ...
      try {
        ...
        PathHelper.Images.SaveStreamToUserPhoto(Request.Files[0].InputStream, CoachInfo.FirstName, CoachInfo.LastName);
