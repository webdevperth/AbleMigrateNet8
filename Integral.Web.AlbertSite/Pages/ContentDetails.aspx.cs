...
namespace Integral.Web.PortalSite.Pages_Albert {
  ...
  public partial class ContentDetails : AppCode.PageBaseClasses.ModulePageBase {
    ...
    void SaveContentItem(AjaxSubmitHelper ajax) {
      ...
      if (CurrentContentFileType == PathHelper.Content.ContentFileType.CoverImage || CurrentContentFileType == PathHelper.Content.ContentFileType.Image) {
        ...
        PathHelper.Images.SaveStreamToContentImage(Request.Files[0].InputStream, contentGuid, CurrentContentFileType);
