<%@ Page Language="C#" AutoEventWireup="true"
  CodeFile="ProgramSendSurvey.aspx.cs"
  Inherits="Integral.Web.PortalSite.Pages_Albert.ProgramSendSurvey"
    ...
    <form class="form-horizontal" id="clientForm">
      ...
      <div class="form-group ajaxSubmit-field row surveyList">
        ...
        <div class="col-md-6 col-sm-12 col-xs-12">
          <select class="form-control" data-placeholder="survey template" id="selSurvey" name="<%= FormFields.SurveyId_FieldName %>" size="1">
      ...
      <div class="closeDates">
        ...
        <%= WebHelper.GetInputDateRow("When to Send Survey:", FormFields.SendDate_FieldName,
        ...
        <div class="coacheeCloseDateArea">
          <%= WebHelper.GetInputDateRow("Participant Close Date:", FormFields.SelfClose_FieldName,
        ...
        <div class="ratersCloseDateArea">
          <%= WebHelper.GetInputDateRow("Rater (Final) Close Date:", FormFields.RaterClose_FieldName,
  ...
  <script type="text/javascript">
    (function($) {
      ...
      $(document).ready(function() {
        ...
        inpSelfClose = $('input[name="<%= FormFields.SelfClose_FieldName %>"]');
        inpRaterClose = $('input[name="<%= FormFields.RaterClose_FieldName %>"]');
        inpSendDate = $('input[name="<%= FormFields.SendDate_FieldName %>"]');
      ...
      function SendSurvey() {
        ...
        common_ConfirmDialog("Confirm Send Survey to <%= ProgramInfo.ParticipantCount %> Participants", btnSend.text() + "?",
          function (confirmed) {
