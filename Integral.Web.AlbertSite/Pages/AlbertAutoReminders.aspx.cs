...
namespace Integral.Web.PortalSite.Pages_Albert {
  ...
  public partial class AlbertAutoReminders : System.Web.UI.Page {
    ...
    void Main() {
      ...
      Response.ContentType = WebHelper.GetContentTypeString(WebHelper.HttpContentType.Text);
      ...
      LogMessage("Called by: " + Request.UserHostAddress + " " + Request.UserHostName);
      LogMessage("QueryString: " + Request.Url.Query);
    ...
    void RunDailyProcesses() {
      ...
      if (!ConfigHelper.IsDevServer && Application["AutoReminders_LastRun"] != null && (DateTime.UtcNow - (DateTime)Application["AutoReminders_LastRun"]).TotalSeconds < 30) {
        LogMessage("Aborting - last run less than 30 seconds ago.");
        return;
      }

      Application["AutoReminders_LastRun"] = DateTime.UtcNow;
