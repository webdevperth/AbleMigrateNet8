<%@ Page Language="C#" AutoEventWireup="true" CodeFile="OrganisationProjects.aspx.cs"
  Inherits="Integral.Web.PortalSite.Pages_Albert.OrganisationProjects" MasterPageFile="~/MasterPages/AdminLTE.Master" %>
    ...
    <table class="table table-bordered table-hover table-rowlink limit-width" data-rowlink-url="<%= GetRowLinkUrl() %>">
      <thead>
        <tr>
          ...
          <th class="type-revenueprogress">Revenue</th>
        </tr>
    ...
    (function ($) {
      ...
      function SearchKeyTimeout($inp, isImmediate) {
        ...
        $.get(location.pathname,
          {
            "<%= PathHelper.AbleUrlKeys.JobSearchTerm %>": encodeURIComponent(newSearchValue),
            "<%= PathHelper.AbleUrlKeys.ProjectStatusToggle %>": encodeURIComponent(currentActiveToggleValue),
      ...
      function PopulateTableBody(json) {
        ...
        var showLinkToInvoicing = <%= SessionHelper.AppAccess.Companies.CanViewProjectsLinkToInvoicing().ToJSTrueFalse() %>;
