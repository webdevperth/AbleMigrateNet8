<%@ Page Language="C#" AutoEventWireup="true"
  CodeFile="OrganisationIOSReports.aspx.cs"
  Inherits="Integral.Web.PortalSite.Pages_Albert.OrganisationIOSReports"
...
<asp:Content ID="BodyContent" runat="server" ContentPlaceHolderID="BodyContent">
              ...
              <%
                if (!SurveyList.IsNullOrEmpty()) {
                  foreach (var thisSurvey in SurveyList) { %>
                    <tr tabindex="0" <%= WebHelper.GetSurveyListRowDataAttrs(CompanyInfo, thisSurvey) %>>
  ...
  <% void ShowReport() { %>
    ...
    <!-- begin top nav -->
    <ul class="nav nav-tabs nav-tabs-underlined last-tab-right" id="pageTabs">
