...
namespace Integral.Web.PortalSite.Pages_Albert {
  ...
  public class SkillsViewer : AppCode.PageBaseClasses.LoggedInPageModel {
    ...
    void DoPost(AjaxSubmitHelper ajax) {
      ...
      if (WebHelper.GetFormValue(PathHelper.FormKeys.AjaxAction) == AjaxAction.GetPrograms) {
        GetProgramOptionsHtml(ajax, projectInfo);
      } else if (WebHelper.GetFormValue(PathHelper.FormKeys.AjaxAction) == AjaxAction.GetStats) {
