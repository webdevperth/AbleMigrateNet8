...
namespace Integral.Web.PortalSite.Pages_Albert {
  ...
  public partial class SurveyViewer : AppCode.PageBaseClasses.LoggedInPageBase {
    ...
    protected void Page_Load(object sender, EventArgs e) {
      ...
      if (!SystemWeb.IsHttpPost) {
        ...
        if (Request.Form[PathHelper.FormKeys.AjaxAction] == AjaxAction.GetSurveys) {

          GetSurveySelectOptionsHtml();
          return;

        } else if (Request.Form[PathHelper.FormKeys.AjaxAction] == AjaxAction.GetReport) {
