...
namespace Integral.Web.PortalSite.Pages_Albert {
  ...
  public partial class ModuleEdit : AppCode.PageBaseClasses.ModulePageBase {
    ...
    void SaveCoverImage(AjaxSubmitHelper ajax) {
      ...
      PathHelper.Images.SaveStreamToContentImage(Request.Files[0].InputStream, moduleGuid, PathHelper.Content.ContentFileType.CoverImage);
    }
