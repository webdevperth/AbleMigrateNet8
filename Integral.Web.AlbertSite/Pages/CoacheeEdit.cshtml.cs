...
namespace Integral.Web.PortalSite.Pages_Albert {
  ...
  public class CoacheeEdit : AppCode.PageBaseClasses.CoacheeInfoBase {
    ...
    public List<DbHelper.CoacheeProgramStatus.ProgramStatusInfo> ProgramStatusList = null;
    ...
    // Helper that returns the On-Boarding Date row html (extracted to avoid
    // Razor parser issues with multi-line verbatim interpolated strings).
    public string GetWelcomeEmailDateRowHtml() {
      ...
      return WebHelper.GetInputDateRow(
    ...
    // Helper that returns the Meet Coach Date row html (extracted to avoid
    // Razor parser issues with multi-line verbatim interpolated strings).
    public string GetMeetCoachDateRowHtml() {

      string rightHtml = $@"{(CoacheeInfo.MeetCoachEmailSentUtc == null
          ? ""
