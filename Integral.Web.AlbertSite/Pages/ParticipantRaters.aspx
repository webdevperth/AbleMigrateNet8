<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ParticipantRaters.aspx.cs"
    Inherits="Integral.Web.PortalSite.Pages_Albert.ParticipantRaters" MasterPageFile="~/MasterPages/Public.Master" %>
...
<asp:Content ID="BodyContent" runat="server" ContentPlaceHolderID="BodyContent">
  ...
  <% if (ContentVisible) { %>
    ...
    <div class="container">
      ...
      <h2><%= SelfParticipantInfo.FullName %></h2>
  ...
  <script type="text/javascript">
    (function($) {
      ...
      $(document).ready(function() {
        ...
        if (noParts) {
          $(".msgNoParts").show();
          if ($AddForm.length == 1 ) $AddForm.find("input:text:first").focus();
        }
