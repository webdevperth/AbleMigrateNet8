<%@ Page Language="C#" AutoEventWireup="true"
  CodeFile="PartnerPayRuns.aspx.cs"
  Inherits="Integral.Web.PortalSite.Pages_Albert.PartnerPayRuns"
...
<asp:Content ID="BodyContent" runat="server" ContentPlaceHolderID="BodyContent">
  ...
  <div class="mb30 payrunsContainer">
    <select id="selPayRuns" class="w275">
      <%= WebHelper.Payruns.GetPayRunSelectOptions(CoachInfo, UrlPayRunId) %>
    </select>
  </div>
    ...
    (function ($) {
      ...
      function UpdateUrlAddress(payRunId) {
        if (payRunId > 0) {
          ...
          HistoryReplaceUrlParams({ "<%= PathHelper.AbleUrlKeys.PayRunId %>": null });
        }
      }
