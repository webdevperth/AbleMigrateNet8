...
namespace Integral.Web.PortalSite.Pages_Albert {
  ...
  public partial class ProjectAccess : AppCode.PageBaseClasses.ProjectPageBase {
    ...
    void AddUser(AjaxSubmitHelper ajax) {
      ...
      var selectedJobIds = ("" + Request.Form[FormFields.GrantAccessJobId]).ToIntList();
    ...
    void UpdateUser(AjaxSubmitHelper ajax) {
      ...
      var selectedJobIds = ("" + Request.Form[GetProgramChkName(user.UserId)]).ToIntList();
