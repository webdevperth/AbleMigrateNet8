<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PeopleDetails.aspx.cs"
    Inherits="Integral.Web.PortalSite.Pages_Albert.PeopleDetails" MasterPageFile="~/MasterPages/AdminLTE.Master" %>
  ...
  <section class="content">
    ...
    <% void AISummary() { %>
      <div class="boxBorder ai-summary-box mw600">
        ...
        <div class="boxBody nicer-scrollbar"><%= WebHelper.MarkdownToHtml(ProfileInfo.UserActivity?.AISummaryText) %></div>
      </div>
    <% }; %>
