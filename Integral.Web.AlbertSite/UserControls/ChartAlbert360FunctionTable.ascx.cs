...
namespace Integral.Web.PortalSite.UserControls {
  ...
  public partial class ChartAlbert360FunctionTable : System.Web.UI.UserControl {
    ...
    protected void Page_Load(object sender, EventArgs e) {
      ...
      // Go thru results (individual questions) and accumulate averages for each distinct heading.
    ...
    public string GetCSSPercentFromScore(double? score) {
      ...
      return ((double)score * 10).ToString("0") + "%"; // css value representing percentage of score out of 10. i.e. 8.3pts = "83%"
    }
    ...
    public class TableRowInfo {
      ...
      public void CalcProgress() {
        ...
        if (QuestionInfo.Scores.ScorePreviousSelf.Avg != null) {
          ...
          ProgressPercent = progressPoints / (double)QuestionInfo.Scores.ScorePreviousSelf.Avg * 100; // "percentage difference" to previous score
        }
