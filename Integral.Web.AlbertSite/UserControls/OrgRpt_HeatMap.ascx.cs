...
namespace Integral.Web.PortalSite.UserControls {
  ...
  public partial class OrgRpt_HeatMap : OrgReportControlBase {

    int categoryDimensionNo;
    string includeDimCodes;
    public List<HeatMapRow> HeatMapData;

    public OrgRpt_HeatMap() {
      ignorePartCount = true; // Don't check participant count for heat map.
    }
